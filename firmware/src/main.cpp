...
// Mapping entrepôts -> angles servo
#define WAREHOUSE_A_ANGLE   5    // Magasin A
#define WAREHOUSE_B_ANGLE   15   // Magasin B
#define WAREHOUSE_C_ANGLE   25   // Magasin C
#define DEFAULT_ANGLE       15   // Position par defaut (au centre)
